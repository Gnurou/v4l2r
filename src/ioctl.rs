//! Provides safe versions of the V4L2 ioctls through simple functions working
//! on a RawFd and Rust variants of the V4L2 structures. This module can be used
//! directly if that's the level of abstraction you are aiming for.
//!
